...
draw_text(room_width - 240, room_height - 22, app.creator)

var tempMouseover = -1
if point_in_rectangle(mouse_gui_x,mouse_gui_y,317, 27, 317+sprite_get_width(s_menu_playgame), 27+sprite_get_height(s_menu_playgame)) {
